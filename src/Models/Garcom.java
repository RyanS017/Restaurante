...
public class Garcom extends Funcionario {
    ...
    private void inserirCardapio(){
        ...
        this.cardapio.add(new Item("File de Frango", 22.00,"Arroz, feijão, fritas, Filé de frango grelhado"));
        ...
        this.cardapio.add(new Item("Guarana 2L", 14.00,"Guaraná 2L"));
        this.cardapio.add(new Item("Agua 500mL", 5.00,"Água 500mL"));
        this.cardapio.add(new Item("Suco de Maracuja", 15.00,"Suco de Maracujá 1L"));
